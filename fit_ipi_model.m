function ipi = fit_ipi_model(pulses,numComponents)
%ipi = fit_ipi_model(Pulses.ModelCull2)
%provide pulses
%return info about ipis, time in samples

%p are pulses (=Pulses.ModelCull2.wc)
