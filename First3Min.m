function First3Min(infolder,outfolder)
...
for i = 1:numel(dir_list)
    ...
    if strcmp(ext,'.mat') && ~strcmp(filestrings(end),'LS')
        ...
        for j = 1:numel(IPI_results)
            %take first 3 min of ipis
            sixMin = (1e4 * 60 * 3); %time in sample units
            ...
            result_path = strcat(outfolder, root,'_from1stPulseTrain_1st3min',ext);
