...
function BatchFlySongAnalysisOld(daq_file,genotypes,recording_channels,control_genotypes,LLR_threshold)
...
%for y = 1:file_num
    ...
    if strcmp(ext,'.mat');
        ...
        [Analysis_Results,~] = AnalyzeChannelOld(path_file,LLR_threshold);
